...
export class McpServerModal extends Modal {
  ...
  onOpen() {
    ...
    this.modalEl.addClass('vauex-mcp-modal');
    ...
    this.typeFieldsEl = contentEl.createDiv({ cls: 'vauex-mcp-type-fields' });
    this.renderTypeFields();
    ...
    const buttonContainer = contentEl.createDiv({ cls: 'vauex-mcp-buttons' });
  ...
  private renderStdioFields() {
    ...
    cmdSetting.settingEl.addClass('vauex-mcp-cmd-setting');

    const cmdTextarea = cmdSetting.controlEl.createEl('textarea', {
      cls: 'vauex-mcp-cmd-textarea',
    });
    ...
    envSetting.settingEl.addClass('vauex-mcp-env-setting');

    const envTextarea = envSetting.controlEl.createEl('textarea', {
      cls: 'vauex-mcp-env-textarea',
    });
  ...
  private renderUrlFields() {
    ...
    headersSetting.settingEl.addClass('vauex-mcp-env-setting');
